      ...
      <View style={s.fakeContent} pointerEvents="none">
        {[1, 2, 3].map(i => (
          <View key={i} style={s.fakeCard}>
            <View style={s.fakeIcon} />
            <View style={{ flex: 1, gap: 8 }}>
              <View style={[s.fakeLine, { width: '60%' }]} />
              <View style={[s.fakeLine, { width: '40%' }]} />
            </View>
            <View style={s.fakeBadge} />
          </View>
        ))}
      </View>
...
const s = StyleSheet.create({
  ...
  hero: { backgroundColor: '#2563EB', paddingBottom: 28, paddingHorizontal: 20, overflow: 'hidden' },
  decoCircle1: { position: 'absolute', width: 200, height: 200, borderRadius: 100, backgroundColor: '#1D4ED8', opacity: 0.5, top: -60, right: -40 },
  ...
  heroCurve: { height: 20, backgroundColor: '#2563EB', borderBottomLeftRadius: 24, borderBottomRightRadius: 24 },
  ...
  fakeCard: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: '#fff', borderRadius: 16, padding: 14, opacity: 0.4 },
  fakeIcon: { width: 44, height: 44, borderRadius: 14, backgroundColor: '#E5E7EB' },
  fakeLine: { height: 12, borderRadius: 6, backgroundColor: '#E5E7EB' },
  fakeBadge: { width: 60, height: 24, borderRadius: 8, backgroundColor: '#E5E7EB' },
  ...
  lockCard: {
    ...
    alignItems: 'center',
    shadowColor: '#2563EB', shadowOpacity: 0.15, shadowRadius: 24, elevation: 8,
  ...
  backBtn2: { backgroundColor: '#2563EB', paddingHorizontal: 32, paddingVertical: 14, borderRadius: 16 },
